...
$matriculePersonnelConnecte = $_SESSION['matricule_personnel_tasks'];
                        ...
                        <div class="card-body">
                            <h3 class="card-title d-flex align-items-center">
                                ...
                                <span class="text-truncate" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                    <?= htmlspecialchars($serviceObj->obtenirServiceParId($fiche['departement'])['lib_service_tasks']) ?> N° FEB-<?= $fiche['id'] ?>
                                </span>
                            </h3>
