...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 10, mb_convert_encoding('FICHE DE DEMANDE D\'AVANCE SUR SALAIRE', 'ISO-8859-1'), 0, 1, 'C');
        $this->Ln(10);
    }
...
$pdf->SetFont('Arial', 'B', 14);
$pdf->Cell($largeurCle, 10, mb_convert_encoding(number_format($demandeDetails['montant'], 0, ',', ' ') . ' FCFA', 'ISO-8859-1'), 0, 1, 'L');
$pdf->SetFont('Arial', '', 14);
