...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 10, utf8_decode("Liste des Tâches (Déjà Exécutée)"), 0, 1, 'C');
        $this->Ln(5);
    }
...
foreach ($taches as $tache) {
    ...
    // Statut de report
    $pdf->Cell(25, $maxCellHeight, $tache['report_decide'] == 1 ? utf8_decode('Reporté') : utf8_decode('Termine'), 1, 1);
}
