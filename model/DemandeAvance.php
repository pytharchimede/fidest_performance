...
class DemandeAvance {
    ...
    public function ajouterDemandeAvance($nom, $matricule, $fonction, $service, $motif, $montant, $statut) {
        $sql = "INSERT INTO demande_avance_salaire (nom, matricule, fonction, service, motif, montant, statut, date_creat) 
                VALUES (?, ?, ?, ?, ?, ?, ?, NOW())";
        $stmt = $this->pdo->prepare($sql);
        return $stmt->execute([$nom, $matricule, $fonction, $service, $motif, $montant, $statut]);
    }
