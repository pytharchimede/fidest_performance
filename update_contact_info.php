...
<head>
    ...
    <style>
        ...
        .input-field input[type="password"] {
            border-bottom: 2px solid #1d2b57;
            /* Bordure des champs */
        }
                ...
                <form action="request/update_infos.php" method="post" class="col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="email" name="email" type="email" value="<?php echo $user['email_personnel_tasks']; ?>" <?php if ($user['email_personnel_tasks'] != '') {
                                                                                                                                    echo 'readonly';
                                                                                                                                } ?> required>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input id="tel" name="tel" type="text" value="<?php echo $user['tel_personnel_tasks']; ?>" <?php if ($user['tel_personnel_tasks'] != '') {
                                                                                                                            echo 'readonly';
                                                                                                                        } ?> required>
