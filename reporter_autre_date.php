...
<body>
  ...
  <div class="container">
    <div class="soft-design">
      ...
      <form action="request/update_deadline.php" method="post">
        <div class="form-group">
          <input type="hidden" name="task_id" value="<?= $task_id; ?>">

          <label for="new_deadline">Nouvelle date :</label>
          <input type="datetime-local" name="date_report_propose" class="form-control" value="<?= $task['date_report_propose'] ?>" required>
        </div>
